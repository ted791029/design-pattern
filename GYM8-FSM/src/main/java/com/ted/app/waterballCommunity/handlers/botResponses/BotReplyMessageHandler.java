...
public class BotReplyMessageHandler extends BotResponseHandler {


    public BotReplyMessageHandler(BotResponseHandler next) {
        super(next, BotEventResult.BOT_REPLY_MESSAGE);
    }

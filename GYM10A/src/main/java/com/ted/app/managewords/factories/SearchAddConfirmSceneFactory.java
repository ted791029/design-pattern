...
import com.ted.app.managewords.scenes.SearchAddConfirmScene;

public class SearchAddConfirmSceneFactory implements SceneFactory {
    @Override
    public Scene create(AppContext context) {
        return new SearchAddConfirmScene(context);
    }
}

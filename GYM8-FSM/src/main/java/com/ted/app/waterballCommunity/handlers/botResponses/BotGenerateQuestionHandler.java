...
public class BotGenerateQuestionHandler extends BotResponseHandler {

    public BotGenerateQuestionHandler(BotResponseHandler next) {
        super(next, BotEventResult.BOT_GENERATE_QUESTION);
    }
